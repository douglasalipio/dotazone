...
public class BuildHeroActivity extends BaseActivity implements OnClickListener, BuildHeroAction, IabHelper.OnIabPurchaseFinishedListener, IabHelper.QueryInventoryFinishedListener {
                ...
                mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
                    ...
                    public void onIabSetupFinished(IabResult result) {
                        if (!result.isSuccess()) {
                            ...
                            Toast.makeText(BuildHeroActivity.this, getResources().getString(R.string.buy_item_error), Toast.LENGTH_SHORT).show();
                            return;
                        }

                        mHelper.launchPurchaseFlow(BuildHeroActivity.this, BillingUtils.PREMIUM, requestId, BuildHeroActivity.this, payload);
                    }
                });
